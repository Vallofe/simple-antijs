...
### How to run ?
``` python
$ git clone https://github.com/Vallofe/simple-antijs
$ cd simple-antijs
$ python3 login.py
```
### Authtoken
Input your Token or change your Email and Password <a href="https://github.com/Vallofe/simple-antijs/blob/main/token/login.json">here</a>
